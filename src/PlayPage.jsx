...
export const PlayPage = ({ handleChangePage, handleDarkMode, grid, currentLevel, playingLevel, gridAnswers, changeCurrentLevel }) => {
  const [currentGrid, setCurrentGrid] = useState(gridAnswers[0]);
  ...
  return (
    <div className="title">
        <button className="dot-play" onClick={()=> handleDarkMode((previousDarkMode)=> 
            !previousDarkMode)}>
            Light/Dark Mode
        </button>
        <div className="level-height">
            <div style={{display: "flex", justifyContent: "flex-start"}} className="level-12">
            ...
            <div style={{ height: "3vh", display: "flex", justifyContent: "flex-start" }} className="bridges-no-islands">
                <div className="bridge bridge-1" style={{opacity: currentGrid[1][0]}} onClick={() => handleBridge(1, 0)}></div>
                <div className="bridge-horizontal-extra" style={{opacity: "0"}}></div>
            ...
            <div style={{ height: "3vh", display: "flex", justifyContent: "flex-start"}} className="bridges-no-islands">
                <div className="bridge bridge-1" style={{opacity: currentGrid[3][0]}} onClick={() => handleBridge(3, 0)}></div>
                <div className="bridge-horizontal-extra" style={{opacity: "0"}}></div>
            ...
            <div style={{ height: "3vh", display: "flex", justifyContent: "flex-start" }} className="bridges-no-islands">
                <div className="bridge bridge-1" style={{opacity: currentGrid[5][0]}} onClick={() => handleBridge(5, 0)}></div>
                <div className="bridge-horizontal-extra" style={{opacity: "0"}}></div>
