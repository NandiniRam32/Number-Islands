...
export const LevelsPage = ({ handleChangePage, handleDarkMode, currentLevel, setPlayingLevel }) => {
  return (
    <div className="title">
        ...
        <div style={{display: "flex", marginLeft: "0vw"}} className="levels-top">
            <span className="level-button level-10" onClick={() => {handleChangePage('play'); setPlayingLevel(1);}}>1</span>
        ...
        <div style={{display: "flex"}} className="level-7">
        ...
        <div style={{height: "19.7vh", display: "flex"}}>
            <span className={`level-button ${10 > currentLevel ? 'level-button-not-reached' : ''} level-10`} onClick={() => {handleChangePage('play'); setPlayingLevel(10);}}>10</span>
